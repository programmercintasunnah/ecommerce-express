...
userRouter.post("/register", async (req, res) => {
  const { name, email, password, is_merchant, phone } = req.body;
...
userRouter.put("/:id", async (req, res) => {
  const { id } = req.params;
  const { name, email, phone, password, is_merchant } = req.body;
  ...
  const data = { name, email, phone, password: hashedPassword, is_merchant };
